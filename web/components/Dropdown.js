...
export default function Dropdown() {
  ...
  return (
    <Menu as="div" className="w-24 h-12 relative flex items-center shadow-md">
      ...
      >
        <Menu.Items className="absolute right-0 w-56 mt-24 origin-top-right bg-gray-700 divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
