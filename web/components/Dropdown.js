  ...
  return (
    <Menu as="div" className="w-24 h-12 relative flex items-center shadow-md">
      <div className="w-full absolute right-1 group">
        <Menu.Button className="flex items-center w-full px-4 py-3 
                                text-sm font-medium text-white 
                              bg-gray-900 rounded-full hover:bg-[#3E3E3E]">
      ...
      >
        <Menu.Items className="absolute right-0 w-56 mt-24 origin-top-right 
                            bg-gray-700 divide-y divide-gray-100 rounded-md 
